"""Schema implementation for LlamaCpp provider."""

import langextract as lx
from langextract import schema


class LlamaCppSchema(lx.schema.BaseSchema):
    """Schema implementation for LlamaCpp structured output."""
    ...
    def from_examples(cls, examples_data, attribute_suffix="_attributes"):
        ...
        Returns:
            A configured LlamaCppSchema instance.
        """
        extraction_types = {}
